//========================================================================
// VAddRecFN__expWidth_9__sigWidth_23_v.cpp
//========================================================================
...
#include "obj_dir_AddRecFN__expWidth_9__sigWidth_23/VAddRecFN__expWidth_9__sigWidth_23.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_AddRecFN__expWidth_9__sigWidth_23/VAddRecFN__expWidth_9__sigWidth_23__Syms.h"
#include "svdpi.h"
#endif
...
extern "C" {
  ...
  } VAddRecFN__expWidth_9__sigWidth_23_t;

  // Exposed methods
  VAddRecFN__expWidth_9__sigWidth_23_t * create_model( const char * );
  void destroy_model( VAddRecFN__expWidth_9__sigWidth_23_t *);
  void comb_eval( VAddRecFN__expWidth_9__sigWidth_23_t * );
  void seq_eval( VAddRecFN__expWidth_9__sigWidth_23_t * );
  void assert_en( bool en );

  #if VLINETRACE
  void trace( VAddRecFN__expWidth_9__sigWidth_23_t *, char * );
  #endif
...
VAddRecFN__expWidth_9__sigWidth_23_t * create_model( const char *vcd_filename ) {

  VAddRecFN__expWidth_9__sigWidth_23_t * m;
  VAddRecFN__expWidth_9__sigWidth_23   * model;

  Verilated::randReset( 0 );
  Verilated::randSeed( 0 );

  m     = (VAddRecFN__expWidth_9__sigWidth_23_t *) malloc( sizeof(VAddRecFN__expWidth_9__sigWidth_23_t) );
  model = new VAddRecFN__expWidth_9__sigWidth_23();
...
void destroy_model( VAddRecFN__expWidth_9__sigWidth_23_t * m ) {

  #if VM_COVERAGE
    VerilatedCov::write( "coverage.dat" );
  #endif

  VAddRecFN__expWidth_9__sigWidth_23 * model = (VAddRecFN__expWidth_9__sigWidth_23 *) m->model;
...
void comb_eval( VAddRecFN__expWidth_9__sigWidth_23_t * m ) {
...
void seq_eval( VAddRecFN__expWidth_9__sigWidth_23_t * m ) {
...
#if VLINETRACE
void trace( VAddRecFN__expWidth_9__sigWidth_23_t * m, char* str ) {
  ...
  svSetScope( &model->__VlSymsp->__Vscope_AddRecFN___05FexpWidth_9___05FsigWidth_23__v );
