...
VL_ATTR_COLD void Vcgra_test_ChannelRTL___05Fd5433e044837250f___stl_sequent__TOP__cgra_test__DOT__MultiCGRA__DOT__cgra___05F0__controller__DOT__send_to_mem_load_request_queue__0(Vcgra_test_ChannelRTL___05Fd5433e044837250f* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vcgra_test__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vcgra_test_ChannelRTL___05Fd5433e044837250f___stl_sequent__TOP__cgra_test__DOT__MultiCGRA__DOT__cgra___05F0__controller__DOT__send_to_mem_load_request_queue__0\n"); );
    // Init
...
VL_ATTR_COLD void Vcgra_test_ChannelRTL___05Fd5433e044837250f___ctor_var_reset(Vcgra_test_ChannelRTL___05Fd5433e044837250f* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vcgra_test__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vcgra_test_ChannelRTL___05Fd5433e044837250f___ctor_var_reset\n"); );
    // Body
    vlSelf->clk = VL_RAND_RESET_I(1);
    vlSelf->reset = VL_RAND_RESET_I(1);
    VL_RAND_RESET_W(201, vlSelf->recv___05Fmsg);
    vlSelf->recv___05Frdy = VL_RAND_RESET_I(1);
    vlSelf->recv___05Fval = VL_RAND_RESET_I(1);
    VL_RAND_RESET_W(201, vlSelf->send___05Fmsg);
    ...
    for (int __Vi0 = 0; __Vi0 < 1; ++__Vi0) {
        VL_RAND_RESET_W(201, vlSelf->__PVT__queues___05F0__DOT__dpath__DOT__rf___05Frdata[__Vi0]);
    }
    for (int __Vi0 = 0; __Vi0 < 1; ++__Vi0) {
        vlSelf->__PVT__queues___05F0__DOT__dpath__DOT__rf___05Fwaddr[__Vi0] = VL_RAND_RESET_I(1);
    }
    for (int __Vi0 = 0; __Vi0 < 1; ++__Vi0) {
        VL_RAND_RESET_W(201, vlSelf->__PVT__queues___05F0__DOT__dpath__DOT__rf___05Fwdata[__Vi0]);
    }
    for (int __Vi0 = 0; __Vi0 < 1; ++__Vi0) {
        vlSelf->__PVT__queues___05F0__DOT__dpath__DOT__rf___05Fwen[__Vi0] = VL_RAND_RESET_I(1);
    }
    for (int __Vi0 = 0; __Vi0 < 2; ++__Vi0) {
        VL_RAND_RESET_W(201, vlSelf->__PVT__queues___05F0__DOT__dpath__DOT__rf__DOT__regs[__Vi0]);
    }
}
