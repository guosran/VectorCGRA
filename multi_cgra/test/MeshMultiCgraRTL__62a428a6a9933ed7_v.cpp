//========================================================================
// VMeshMultiCgraRTL__62a428a6a9933ed7_v.cpp
//========================================================================
...
#include "obj_dir_MeshMultiCgraRTL__62a428a6a9933ed7/VMeshMultiCgraRTL__62a428a6a9933ed7.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_MeshMultiCgraRTL__62a428a6a9933ed7/VMeshMultiCgraRTL__62a428a6a9933ed7__Syms.h"
#include "svdpi.h"
#endif
...
extern "C" {
  ...
  } VMeshMultiCgraRTL__62a428a6a9933ed7_t;

  // Exposed methods
  VMeshMultiCgraRTL__62a428a6a9933ed7_t * create_model( const char * );
  void destroy_model( VMeshMultiCgraRTL__62a428a6a9933ed7_t *);
  void comb_eval( VMeshMultiCgraRTL__62a428a6a9933ed7_t * );
  void seq_eval( VMeshMultiCgraRTL__62a428a6a9933ed7_t * );
  void assert_en( bool en );

  #if VLINETRACE
  void trace( VMeshMultiCgraRTL__62a428a6a9933ed7_t *, char * );
  #endif
...
VMeshMultiCgraRTL__62a428a6a9933ed7_t * create_model( const char *vcd_filename ) {

  VMeshMultiCgraRTL__62a428a6a9933ed7_t * m;
  VMeshMultiCgraRTL__62a428a6a9933ed7   * model;

  Verilated::randReset( 0 );
  Verilated::randSeed( 0 );

  m     = (VMeshMultiCgraRTL__62a428a6a9933ed7_t *) malloc( sizeof(VMeshMultiCgraRTL__62a428a6a9933ed7_t) );
  model = new VMeshMultiCgraRTL__62a428a6a9933ed7();
  ...
  m->clk = &model->clk;
  m->reset = &model->reset;
  m->recv_from_cpu_pkt___05Fmsg = model->recv_from_cpu_pkt___05Fmsg;
  m->recv_from_cpu_pkt___05Frdy = &model->recv_from_cpu_pkt___05Frdy;
  m->recv_from_cpu_pkt___05Fval = &model->recv_from_cpu_pkt___05Fval;
  m->send_to_cpu_pkt___05Fmsg = model->send_to_cpu_pkt___05Fmsg;
  m->send_to_cpu_pkt___05Frdy = &model->send_to_cpu_pkt___05Frdy;
  m->send_to_cpu_pkt___05Fval = &model->send_to_cpu_pkt___05Fval;
...
void destroy_model( VMeshMultiCgraRTL__62a428a6a9933ed7_t * m ) {

  #if VM_COVERAGE
    VerilatedCov::write( "coverage.dat" );
  #endif

  VMeshMultiCgraRTL__62a428a6a9933ed7 * model = (VMeshMultiCgraRTL__62a428a6a9933ed7 *) m->model;
...
void comb_eval( VMeshMultiCgraRTL__62a428a6a9933ed7_t * m ) {
...
void seq_eval( VMeshMultiCgraRTL__62a428a6a9933ed7_t * m ) {
...
#if VLINETRACE
void trace( VMeshMultiCgraRTL__62a428a6a9933ed7_t * m, char* str ) {
  ...
  svSetScope( &model->__VlSymsp->__Vscope_MeshMultiCgraRTL___05F62a428a6a9933ed7__v );
