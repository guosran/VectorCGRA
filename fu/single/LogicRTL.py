...
class LogicRTL(Fu):
  ...
  def construct(s, CtrlPktType, num_inports, num_outports, vector_factor_power = 0):
    ...
    super(LogicRTL, s).construct(CtrlPktType, num_inports, num_outports, 1, vector_factor_power)
    ...
    def comb_logic():
      ...
      if s.recv_opt.val:
        ...
        elif s.recv_opt.msg.operation == OPT_AND_CONST:
        ...
        elif s.recv_opt.msg.operation == OPT_OR_CONST:
          s.send_out[0].msg.payload @= s.recv_in[s.in0_idx].msg.payload | s.recv_const.msg.payload
          s.send_out[0].msg.predicate @= s.recv_in[s.in0_idx].msg.predicate & \
                                         s.reached_vector_factor
          s.recv_all_val @= s.recv_in[s.in0_idx].val & s.recv_const.val
