...
PhiRTL.py
==========================================================================
Functional unit Phi for CGRA tile. Supports multiple PHI_CONST and
PHI_START mapped on the same tile via per-address first flags.
...
class PhiRTL(Fu):
  ...
  def construct(s, CtrlPktType, num_inports, num_outports, vector_factor_power = 0):
    ...
    # PHI_CONST and PHI_START have different behavior when executing for the first time.
    # Per-address first flag ensures multiple PHI ops on the same tile work correctly.
    @update_ff
