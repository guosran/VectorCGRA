...
VL_INLINE_OPT VlCoroutine Vcgra_test___024root___eval_initial__TOP__Vtiming__2(Vcgra_test___024root* vlSelf) {
    ...
    while (1U) {
        co_await vlSelf->__VdlySched.delay(5ULL, nullptr, 
                                           "sv_test/MeshMultiCgraRTL_2x2_fir_vector_global_reduce_tb.v", 
                                           355);
...
bool Vcgra_test___024root___eval_phase__act(Vcgra_test___024root* vlSelf) {
    ...
    // Init
    VlTriggerVec<469> __VpreTriggered;
...
#endif
            VL_FATAL_MT("sv_test/MeshMultiCgraRTL_2x2_fir_vector_global_reduce_tb.v", 7, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("sv_test/MeshMultiCgraRTL_2x2_fir_vector_global_reduce_tb.v", 7, "", "Active region did not converge.");
            }
