...
#-------------------------------------------------------------------------
# Div__WIDTH_32__CYCLE_2
#-------------------------------------------------------------------------

class Div__WIDTH_32__CYCLE_2( Component ):
  id_ = 0
  ...
  def __init__( s, *args, **kwargs ):
    ...
    #   'libDiv__WIDTH_32__CYCLE_2_v.so', os.path.getmtime( './libDiv__WIDTH_32__CYCLE_2_v.so' ) )

    # Import the shared library containing the model. We defer
    # construction to the elaborate_logic function to allow the user to
    # set the vcd_file.
    s._ffi_inst = s.ffi.dlopen('./libDiv__WIDTH_32__CYCLE_2_v.so')

    # increment instance count
    Div__WIDTH_32__CYCLE_2.id_ += 1
  ...
  def construct( s, *args, **kwargs ):
    ...
    if 0:
      if False:
        ...
        verilator_vcd_file = "Div__WIDTH_32__CYCLE_2.verilator1.vcd"
