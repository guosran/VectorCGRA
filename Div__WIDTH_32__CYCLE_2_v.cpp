...
#include "obj_dir_Div__WIDTH_32__CYCLE_2/VDiv__WIDTH_32__CYCLE_2.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_Div__WIDTH_32__CYCLE_2/VDiv__WIDTH_32__CYCLE_2__Syms.h"
#include "svdpi.h"
#endif
...
extern "C" {
  ...
  } VDiv__WIDTH_32__CYCLE_2_t;

  // Exposed methods
  VDiv__WIDTH_32__CYCLE_2_t * create_model( const char * );
  void destroy_model( VDiv__WIDTH_32__CYCLE_2_t *);
  void comb_eval( VDiv__WIDTH_32__CYCLE_2_t * );
  void seq_eval( VDiv__WIDTH_32__CYCLE_2_t * );
  void assert_en( bool en );

  #if VLINETRACE
  void trace( VDiv__WIDTH_32__CYCLE_2_t *, char * );
  #endif
...
VDiv__WIDTH_32__CYCLE_2_t * create_model( const char *vcd_filename ) {

  VDiv__WIDTH_32__CYCLE_2_t * m;
  VDiv__WIDTH_32__CYCLE_2   * model;

  Verilated::randReset( 0 );
  Verilated::randSeed( 0 );

  m     = (VDiv__WIDTH_32__CYCLE_2_t *) malloc( sizeof(VDiv__WIDTH_32__CYCLE_2_t) );
  model = new VDiv__WIDTH_32__CYCLE_2();
  ...
  m->clk = &model->clk;
  m->dividend = &model->dividend;
  m->divisor = &model->divisor;
  m->quotient = &model->quotient;
  m->remainder = &model->remainder;
  m->reset = &model->reset;
...
void destroy_model( VDiv__WIDTH_32__CYCLE_2_t * m ) {

  #if VM_COVERAGE
    VerilatedCov::write( "coverage.dat" );
  #endif

  VDiv__WIDTH_32__CYCLE_2 * model = (VDiv__WIDTH_32__CYCLE_2 *) m->model;
...
void comb_eval( VDiv__WIDTH_32__CYCLE_2_t * m ) {
...
void seq_eval( VDiv__WIDTH_32__CYCLE_2_t * m ) {
...
#if VLINETRACE
void trace( VDiv__WIDTH_32__CYCLE_2_t * m, char* str ) {
  ...
  svSetScope( &model->__VlSymsp->__Vscope_Div___05FWIDTH_32___05FCYCLE_2__v );
