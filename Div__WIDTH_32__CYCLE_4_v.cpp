...
#include "obj_dir_Div__WIDTH_32__CYCLE_4/VDiv__WIDTH_32__CYCLE_4.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_Div__WIDTH_32__CYCLE_4/VDiv__WIDTH_32__CYCLE_4__Syms.h"
#include "svdpi.h"
#endif
...
extern "C" {
  ...
  #if VLINETRACE
  void trace( VDiv__WIDTH_32__CYCLE_4_t *, char * );
  #endif
...
VDiv__WIDTH_32__CYCLE_4_t * create_model( const char *vcd_filename ) {

  VDiv__WIDTH_32__CYCLE_4_t * m;
  VDiv__WIDTH_32__CYCLE_4   * model;

  Verilated::randReset( 0 );
  Verilated::randSeed( 0 );

  m     = (VDiv__WIDTH_32__CYCLE_4_t *) malloc( sizeof(VDiv__WIDTH_32__CYCLE_4_t) );
  model = new VDiv__WIDTH_32__CYCLE_4();
...
void destroy_model( VDiv__WIDTH_32__CYCLE_4_t * m ) {

  #if VM_COVERAGE
    VerilatedCov::write( "coverage.dat" );
  #endif

  VDiv__WIDTH_32__CYCLE_4 * model = (VDiv__WIDTH_32__CYCLE_4 *) m->model;
...
void comb_eval( VDiv__WIDTH_32__CYCLE_4_t * m ) {
...
void seq_eval( VDiv__WIDTH_32__CYCLE_4_t * m ) {
...
#if VLINETRACE
void trace( VDiv__WIDTH_32__CYCLE_4_t * m, char* str ) {
  ...
  svSetScope( &model->__VlSymsp->__Vscope_Div___05FWIDTH_32___05FCYCLE_4__v );
