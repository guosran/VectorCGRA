//========================================================================
// VFNToRecFN__expWidth_9__sigWidth_23_v.cpp
//========================================================================
...
#include "obj_dir_FNToRecFN__expWidth_9__sigWidth_23/VFNToRecFN__expWidth_9__sigWidth_23.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_FNToRecFN__expWidth_9__sigWidth_23/VFNToRecFN__expWidth_9__sigWidth_23__Syms.h"
#include "svdpi.h"
#endif
...
extern "C" {
  ...
  } VFNToRecFN__expWidth_9__sigWidth_23_t;

  // Exposed methods
  VFNToRecFN__expWidth_9__sigWidth_23_t * create_model( const char * );
  void destroy_model( VFNToRecFN__expWidth_9__sigWidth_23_t *);
  void comb_eval( VFNToRecFN__expWidth_9__sigWidth_23_t * );
  void seq_eval( VFNToRecFN__expWidth_9__sigWidth_23_t * );
  void assert_en( bool en );

  #if VLINETRACE
  void trace( VFNToRecFN__expWidth_9__sigWidth_23_t *, char * );
  #endif
...
VFNToRecFN__expWidth_9__sigWidth_23_t * create_model( const char *vcd_filename ) {

  VFNToRecFN__expWidth_9__sigWidth_23_t * m;
  VFNToRecFN__expWidth_9__sigWidth_23   * model;

  Verilated::randReset( 0 );
  Verilated::randSeed( 0 );

  m     = (VFNToRecFN__expWidth_9__sigWidth_23_t *) malloc( sizeof(VFNToRecFN__expWidth_9__sigWidth_23_t) );
  model = new VFNToRecFN__expWidth_9__sigWidth_23();
...
void destroy_model( VFNToRecFN__expWidth_9__sigWidth_23_t * m ) {

  #if VM_COVERAGE
    VerilatedCov::write( "coverage.dat" );
  #endif

  VFNToRecFN__expWidth_9__sigWidth_23 * model = (VFNToRecFN__expWidth_9__sigWidth_23 *) m->model;
...
void comb_eval( VFNToRecFN__expWidth_9__sigWidth_23_t * m ) {
...
void seq_eval( VFNToRecFN__expWidth_9__sigWidth_23_t * m ) {
...
#if VLINETRACE
void trace( VFNToRecFN__expWidth_9__sigWidth_23_t * m, char* str ) {
  ...
  svSetScope( &model->__VlSymsp->__Vscope_FNToRecFN___05FexpWidth_9___05FsigWidth_23__v );
