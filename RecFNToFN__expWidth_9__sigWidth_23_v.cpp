//========================================================================
// VRecFNToFN__expWidth_9__sigWidth_23_v.cpp
//========================================================================
...
#include "obj_dir_RecFNToFN__expWidth_9__sigWidth_23/VRecFNToFN__expWidth_9__sigWidth_23.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_RecFNToFN__expWidth_9__sigWidth_23/VRecFNToFN__expWidth_9__sigWidth_23__Syms.h"
#include "svdpi.h"
#endif
...
extern "C" {
  ...
  } VRecFNToFN__expWidth_9__sigWidth_23_t;

  // Exposed methods
  VRecFNToFN__expWidth_9__sigWidth_23_t * create_model( const char * );
  void destroy_model( VRecFNToFN__expWidth_9__sigWidth_23_t *);
  void comb_eval( VRecFNToFN__expWidth_9__sigWidth_23_t * );
  void seq_eval( VRecFNToFN__expWidth_9__sigWidth_23_t * );
  void assert_en( bool en );

  #if VLINETRACE
  void trace( VRecFNToFN__expWidth_9__sigWidth_23_t *, char * );
  #endif
...
VRecFNToFN__expWidth_9__sigWidth_23_t * create_model( const char *vcd_filename ) {

  VRecFNToFN__expWidth_9__sigWidth_23_t * m;
  VRecFNToFN__expWidth_9__sigWidth_23   * model;

  Verilated::randReset( 0 );
  Verilated::randSeed( 0 );

  m     = (VRecFNToFN__expWidth_9__sigWidth_23_t *) malloc( sizeof(VRecFNToFN__expWidth_9__sigWidth_23_t) );
  model = new VRecFNToFN__expWidth_9__sigWidth_23();
...
void destroy_model( VRecFNToFN__expWidth_9__sigWidth_23_t * m ) {

  #if VM_COVERAGE
    VerilatedCov::write( "coverage.dat" );
  #endif

  VRecFNToFN__expWidth_9__sigWidth_23 * model = (VRecFNToFN__expWidth_9__sigWidth_23 *) m->model;
...
void comb_eval( VRecFNToFN__expWidth_9__sigWidth_23_t * m ) {
...
void seq_eval( VRecFNToFN__expWidth_9__sigWidth_23_t * m ) {
...
#if VLINETRACE
void trace( VRecFNToFN__expWidth_9__sigWidth_23_t * m, char* str ) {
  ...
  svSetScope( &model->__VlSymsp->__Vscope_RecFNToFN___05FexpWidth_9___05FsigWidth_23__v );
