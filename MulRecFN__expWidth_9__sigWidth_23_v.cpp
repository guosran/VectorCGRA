//========================================================================
// VMulRecFN__expWidth_9__sigWidth_23_v.cpp
//========================================================================
...
#include "obj_dir_MulRecFN__expWidth_9__sigWidth_23/VMulRecFN__expWidth_9__sigWidth_23.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_MulRecFN__expWidth_9__sigWidth_23/VMulRecFN__expWidth_9__sigWidth_23__Syms.h"
#include "svdpi.h"
#endif
...
extern "C" {
  ...
  #if VLINETRACE
  void trace( VMulRecFN__expWidth_9__sigWidth_23_t *, char * );
  #endif
...
VMulRecFN__expWidth_9__sigWidth_23_t * create_model( const char *vcd_filename ) {

  VMulRecFN__expWidth_9__sigWidth_23_t * m;
  VMulRecFN__expWidth_9__sigWidth_23   * model;

  Verilated::randReset( 0 );
  Verilated::randSeed( 0 );

  m     = (VMulRecFN__expWidth_9__sigWidth_23_t *) malloc( sizeof(VMulRecFN__expWidth_9__sigWidth_23_t) );
  model = new VMulRecFN__expWidth_9__sigWidth_23();
...
void destroy_model( VMulRecFN__expWidth_9__sigWidth_23_t * m ) {

  #if VM_COVERAGE
    VerilatedCov::write( "coverage.dat" );
  #endif

  VMulRecFN__expWidth_9__sigWidth_23 * model = (VMulRecFN__expWidth_9__sigWidth_23 *) m->model;
...
void comb_eval( VMulRecFN__expWidth_9__sigWidth_23_t * m ) {
...
void seq_eval( VMulRecFN__expWidth_9__sigWidth_23_t * m ) {
...
#if VLINETRACE
void trace( VMulRecFN__expWidth_9__sigWidth_23_t * m, char* str ) {
  ...
  svSetScope( &model->__VlSymsp->__Vscope_MulRecFN___05FexpWidth_9___05FsigWidth_23__v );
