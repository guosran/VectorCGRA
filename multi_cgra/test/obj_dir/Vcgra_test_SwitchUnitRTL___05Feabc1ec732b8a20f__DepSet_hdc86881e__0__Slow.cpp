...
VL_ATTR_COLD void Vcgra_test_SwitchUnitRTL___05Feabc1ec732b8a20f___ctor_var_reset(Vcgra_test_SwitchUnitRTL___05Feabc1ec732b8a20f* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vcgra_test__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+                Vcgra_test_SwitchUnitRTL___05Feabc1ec732b8a20f___ctor_var_reset\n"); );
    // Body
    ...
    VL_RAND_RESET_W(89, vlSelf->__PVT__send___05Fmsg);
    ...
    for (int __Vi0 = 0; __Vi0 < 3; ++__Vi0) {
        VL_RAND_RESET_W(89, vlSelf->__PVT__mux___05Fin_[__Vi0]);
    }
