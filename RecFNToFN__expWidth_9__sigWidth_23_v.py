...
#=========================================================================
# VRecFNToFN__expWidth_9__sigWidth_23_v.py
#=========================================================================
...
#-------------------------------------------------------------------------
# RecFNToFN__expWidth_9__sigWidth_23
#-------------------------------------------------------------------------

class RecFNToFN__expWidth_9__sigWidth_23( Component ):
  id_ = 0
  ...
  def __init__( s, *args, **kwargs ):
    ...
    #   'libRecFNToFN__expWidth_9__sigWidth_23_v.so', os.path.getmtime( './libRecFNToFN__expWidth_9__sigWidth_23_v.so' ) )

    # Import the shared library containing the model. We defer
    # construction to the elaborate_logic function to allow the user to
    # set the vcd_file.
    s._ffi_inst = s.ffi.dlopen('./libRecFNToFN__expWidth_9__sigWidth_23_v.so')

    # increment instance count
    RecFNToFN__expWidth_9__sigWidth_23.id_ += 1
  ...
  def construct( s, *args, **kwargs ):
    ...
    if 0:
      if False:
        ...
        verilator_vcd_file = "RecFNToFN__expWidth_9__sigWidth_23.verilator1.vcd"
