...
#=========================================================================
# VFNToRecFN__expWidth_9__sigWidth_23_v.py
#=========================================================================
...
#-------------------------------------------------------------------------
# FNToRecFN__expWidth_9__sigWidth_23
#-------------------------------------------------------------------------

class FNToRecFN__expWidth_9__sigWidth_23( Component ):
  id_ = 0
  ...
  def __init__( s, *args, **kwargs ):
    ...
    #   'libFNToRecFN__expWidth_9__sigWidth_23_v.so', os.path.getmtime( './libFNToRecFN__expWidth_9__sigWidth_23_v.so' ) )

    # Import the shared library containing the model. We defer
    # construction to the elaborate_logic function to allow the user to
    # set the vcd_file.
    s._ffi_inst = s.ffi.dlopen('./libFNToRecFN__expWidth_9__sigWidth_23_v.so')

    # increment instance count
    FNToRecFN__expWidth_9__sigWidth_23.id_ += 1
  ...
  def construct( s, *args, **kwargs ):
    ...
    if 0:
      if False:
        ...
        verilator_vcd_file = "FNToRecFN__expWidth_9__sigWidth_23.verilator1.vcd"
